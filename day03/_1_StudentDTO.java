...
public class _1_StudentDTO {
	...
	//생성자
	public _1_StudentDTO() {}

	public _1_StudentDTO(String stuno, String name, int age, String address) {
		super();
		this.stuno = stuno;
		this.name = name;
		this.age = age;
	...
	public String toString() {
		return String.format("stuno=%s, name=%s, age=%s, address=%s", stuno, name, age, address);
	}
